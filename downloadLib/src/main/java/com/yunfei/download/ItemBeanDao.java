...
public class ItemBeanDao extends AbstractDao<ItemBean, Long> {
    ...
    protected final void bindValues(DatabaseStatement stmt, ItemBean entity) {
        ...
        if (status != null) {
            stmt.bindLong(7, statusConverter.convertToDatabaseValue(status));
        }
    }
    ...
    public ItemBean readEntity(Cursor cursor, int offset) {
        ItemBean entity = new ItemBean( //
            ...
            cursor.isNull(offset + 6) ? null : statusConverter.convertToEntityProperty(cursor.getInt(offset + 6)) // status
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, ItemBean entity, int offset) {
        ...
        entity.setStatus(cursor.isNull(offset + 6) ? null : statusConverter.convertToEntityProperty(cursor.getInt(offset + 6)));
     }
